...
function t12() {
    ...
    out12.innerHTML = 'Hello' + ' ' + name + ' ' +  surname;
}
...
let inp16 = document.querySelector('.i-16-1');
let inp162 = document.querySelector('.i-16-2');
...
let ia = document.querySelector('.i-19-1');
let ib = document.querySelector('.i-19-2');
function t19() {
    let a = +ia.value;
    let b = +ib.value;
