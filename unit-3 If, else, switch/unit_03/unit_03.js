// Task 1
// При нажатии кнопки .b-1 срабатывает функция f1. Функция должна прочитать содержимое .i-1 и сравнить его с числом 4 (сравнение ==). Результат сравнения - true или false выведите в .out.
...
function f7(){
   a = Math.pow(i71.value, i72.value)
   // a = i71.value ** i72.value;
   out7.innerHTML = a;
}
...
function f8(){
   let num = document.querySelector('.s-8');
   switch (+num.value) {
      case 1:
         out8.innerHTML = 'one';
         break;
...
function f10(){
   out10.innerHTML = document.querySelector('.s-100').value;
}
...
function f11(){
   out11.innerHTML = document.querySelector('.s-110').value;
}
