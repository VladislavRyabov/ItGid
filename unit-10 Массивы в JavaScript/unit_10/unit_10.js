...
let ar1 = ['Vladislav', 32, true, 1991, 'Ryabov', false];
...
let ar2 = ['vladislav', 32, true, 1991, 'ryabov', false];
...
function f19() {
    ...
    out19.innerHTML = ar19.indexOf(max);
}
